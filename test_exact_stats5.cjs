...
console.log("csvTotalExpense (only refund as negative expense):", csvTotalExpense);
console.log("csvTotalIncome (only refund as negative expense):", csvTotalIncome);
