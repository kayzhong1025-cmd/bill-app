...
console.log("csvTotalExpense (all income as income, ignore 不计收支):", csvTotalExpense);
console.log("csvTotalIncome (all income as income, ignore 不计收支):", csvTotalIncome);
